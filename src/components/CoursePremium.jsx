            ...
            <div className="max-w-[1240px] max-w-md pt-[4rem] pb-[2rem] mx-auto bg-white ">
                ...
                <div className="bg-white px-6 py-3 rounded-lg shadow-md shadow-[red]">
                    ...
                    <div className="font-medium text-left">
                        ...
                        <p className="py-5 text-xl mx-8 text-[red]">Additional Benefits
                            Why will you choose this course?</p>
                        <ul className=" list-decimal list-outside">
                            <li className="py-2 border-b mx-8">After course completion certification provided from Learn Develop & grow.</li>
                            <li className="py-2 border-b mx-8">After course completion get a chance to interact with the industry experts.</li>
                            <li className="py-2 border-b mx-8">Get free career counseling.</li>
                            <li className="py-2 border-b mx-8">Verbal examination will be taken.</li>
                            <li className="py-2 border-b mx-8">Recognition for outstanding performers.</li>
                            <li className="py-2 border-b mx-8">2 Excursions in a year - <br /> a. Industry visit <br /> b. Leisure Trip </li>
                            <li className="py-2 border-b mx-8">We also help our students to grab the opportunity to study & work in Europe & Middle East to learn, earn & settle.</li>
                        </ul>
                        <p className="py-2 text-xl mx-8 text-[red] ">Certificate Provided</p>
